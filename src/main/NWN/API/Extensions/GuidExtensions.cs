...
namespace NWN.API
{
  ...
  public static class GuidExtensions
  {
    ...
    public static T ToNwObjectSafe<T>(this Guid objectId) where T : NwObject => NwObjectFactory.CreateInternal(objectId) as T;
    ...
    public static T ToNwObject<T>(this Guid objectId) where T : NwObject => (T) NwObjectFactory.CreateInternal(objectId);
    ...
    /// <param name="objectId">The UUID of the object.</param>
    /// <returns>The game object with the given UUID, otherwise returns null if it does not exist.</returns>
    public static NwObject ToNwObject(this Guid objectId) => NwObjectFactory.CreateInternal(objectId);
    ...
    public static string ToUUIDString(this Guid guid) => guid.ToString("D");
  }
}